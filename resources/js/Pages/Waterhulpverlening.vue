<template>
    <app-layout :openForm=openForm setCategory="inzet" @close="openForm=false">
        <template #header>
            Waterhulpverlening
        </template>
        <div class="flex w-full justify-center mt-6">
            <div class="flex flex-wrap justify-center w-8/12 p-6">
                <flex-item @click="setTab(1)" img="img/whvopleiding.jpeg">
                ...
                <flex-item @click="setTab(2)" img="img/toezicht.jpeg">
                ...
                <flex-item @click="setTab(1)" img="img/omslag-1.png">
