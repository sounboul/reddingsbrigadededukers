...
return [
    ...
    */
    ...
    'mailers' => [
        'smtp' => [
            ...
            'encryption' => array_key_exists('MAIL_ENCRYPRION', $_SERVER) ? $_SERVER['MAIL_ENCRYPRION'] : env('MAIL_ENCRYPTION', 'tls'),
    ...
    */
    ...
    'from' => [
        'address' => array_key_exists('MAIL_FROM_ADRESS', $_SERVER) ? $_SERVER['MAIL_FROM_ADRESS'] : env('MAIL_FROM_ADDRESS', 'hello@example.com'),
        'name' => array_key_exists('MAIL_FROM_NAME', $_SERVER) ? $_SERVER['MAIL_FROM_NAME'] : env('MAIL_FROM_NAME', 'Example'),
    ],
